...
rusprojects theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of rusprojects theme and run the following commands:
`nvm use`
...
`drush en rusprojects -y`
`drush config-set system.theme default rusprojects -y`
